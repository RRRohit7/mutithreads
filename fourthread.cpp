...
void matmul1(double** mat1, double** mat2, double** res){
	double sum = 0;
	for(int i=0; i<250; i++){
...
void matmul2(double** mat1, double** mat2, double** res){
	double sum = 0;
...
void matmul3(double** mat1, double** mat2, double** res){
	double sum = 0;
...
void matmul4(double** mat1, double** mat2, double** res){
	double sum = 0;
...
int main(){
	...
	thread one_thread(matmul1, mat1, mat2, res); 
	thread two_thread(matmul2, mat1, mat2, res);
	thread three_thread(matmul3, mat1, mat2, res);
	thread four_thread(matmul4, mat1, mat2, res);
	one_thread.join();	
	two_thread.join();
	three_thread.join();
	four_thread.join();
